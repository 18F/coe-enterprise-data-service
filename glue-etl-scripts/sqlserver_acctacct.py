...
ChangeSchema_node2 = ApplyMapping.apply(
    ...
    mappings=[
        ("acct", "long", "acct", "smallint"),
        ("sub-acct", "long", "sub_acct", "smallint"),
        ("obj-cls", "string", "obj_cls", "varchar"),
        ("amt", "double", "amt", "string"),
        ("dr-cr", "string", "dr_cr", "varchar"),
    ],
...
SQLServertable_node3 = glueContext.write_dynamic_frame.from_catalog(
    ...
    table_name="farm_account_dbo_acctacct",
