...
ChangeSchema_node2 = ApplyMapping.apply(
    ...
    mappings=[
        ("case-id", "string", "case_id", "string"),
        ("st-cde-oblr", "long", "st_cde_oblr", "long"),
        ("cty-cde-oblr", "long", "cty_cde_oblr", "long"),
        ("id-nbr-oblr", "long", "id_nbr_oblr", "long"),
    ],
...
SQLServertable_node3 = glueContext.write_dynamic_frame.from_catalog(
    ...
    table_name="farm_account_dbo_farms_case",
